...
class SymArtikelDebugController extends AbstractController
{
    public function __construct(private FileMakerLayoutRegistry $layouts)
    {
    }

    #[Route('/sym_artikel-json', name: 'sym_artikel_json')]
    public function index(FileMakerClient $fm, LoggerInterface $logger): JsonResponse
    {
        try {
            ...
            $fmLogger->error('sym_Artikel debug error: '.$e->getMessage(), ['exception' => $e, 'layout' => $layout]);
